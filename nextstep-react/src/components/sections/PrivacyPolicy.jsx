...
/**
 * Componente PrivacyPolicy - Política de Privacidad de Nextstep
 * Implementa estructura semántica y accesible
 */
function PrivacyPolicy({ showDeletionInstructions }) {
  ...
  return (
    <section id="privacidad" className="section privacy-policy" aria-labelledby="privacy-title">
        ...
        <div className="privacy-content">
          ...
          <div className="privacy-section">
            ...
            <p>
              ...
              Para más información, consulta nuestras <a href="#" onClick={(e) => {
                e.preventDefault();
                if (showDeletionInstructions) {
                  showDeletionInstructions();
                }
              }}>"Instrucciones de Eliminación de Datos de Usuario"</a>.
            </p>
          </div>
